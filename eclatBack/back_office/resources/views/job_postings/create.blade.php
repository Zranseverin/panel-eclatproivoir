        ...
        <div class="card radius-10">
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Créer une Offre d'Emploi</h5>
                ...
                <form action="{{ route('admin.job-postings.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="employment_type" name="employment_type" value="{{ old('employment_type') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="badge_text" name="badge_text" value="{{ old('badge_text') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="badge_class" name="badge_class">
                                    <option value="bg-success" {{ old('badge_class') == 'bg-success' ? 'selected' : '' }}>Succès (Vert)</option>
                                    <option value="bg-primary" {{ old('badge_class') == 'bg-primary' ? 'selected' : '' }}>Principal (Bleu)</option>
                                    <option value="bg-warning" {{ old('badge_class') == 'bg-warning' ? 'selected' : '' }}>Avertissement (Orange)</option>
                                    <option value="bg-danger" {{ old('badge_class') == 'bg-danger' ? 'selected' : '' }}>Danger (Rouge)</option>
                                    <option value="bg-info" {{ old('badge_class') == 'bg-info' ? 'selected' : '' }}>Info (Bleu clair)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="mission" name="mission" rows="4">{{ old('mission') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="responsibilities" name="responsibilities" rows="4">{{ old('responsibilities') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="profile_requirements" name="profile_requirements" rows="4">{{ old('profile_requirements') }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Créer l'offre
                        </button>
                    </div>
                </form>
            </div>
