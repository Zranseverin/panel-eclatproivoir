        ...
        <div class="mobile-toggle-icon d-xl-none">
          ...
          <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item d-none d-xxl-block">
              ...
              <li class="nav-item d-none d-xxl-block">
              <a class="nav-link" href="app-to-do.html">Autres</a>
              </li>
          </ul>
          </div>
            ...
            <li class="nav-item dropdown dropdown-large">
              <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                <div class="user-setting d-flex align-items-center gap-1">
                  ...
                  <div class="user-name d-none d-sm-block">{{ Auth::guard('admin')->user()->nom_complet ?? 'Admin' }}</div>
                </div>
              </a>
                ...
                <li>
                   <a class="dropdown-item" href="#">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                          <h6 class="mb-0 dropdown-user-name">{{ Auth::guard('admin')->user()->nom_complet ?? 'Admin' }}</h6>
