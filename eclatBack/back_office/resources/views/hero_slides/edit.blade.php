        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="bi bi-pencil me-2"></i>Edit Hero Slide</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.hero-slides.update', $heroSlide->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if($heroSlide->background_image)
                                <div class="mb-2">
                                    <img src="{{ asset($heroSlide->background_image) }}" alt="Current Background" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('button1_text') is-invalid @enderror" 
                                       id="button1_text" name="button1_text" value="{{ old('button1_text', $heroSlide->button1_text) }}">
                                @error('button1_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('button1_url') is-invalid @enderror" 
                                       id="button1_url" name="button1_url" value="{{ old('button1_url', $heroSlide->button1_url) }}">
                                @error('button1_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('button2_text') is-invalid @enderror" 
                                       id="button2_text" name="button2_text" value="{{ old('button2_text', $heroSlide->button2_text) }}">
                                @error('button2_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('button2_url') is-invalid @enderror" 
                                       id="button2_url" name="button2_url" value="{{ old('button2_url', $heroSlide->button2_url) }}">
                                @error('button2_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('is_active') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ old('is_active', $heroSlide->is_active) ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ !old('is_active', $heroSlide->is_active) ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
