...
@section('title', 'Create Navbar Brand Configuration')
    ...
    <div class="col-lg-8">
        <div class="card radius-10">
            <div class="card-header bg-transparent">
                <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Create Navbar Brand Configuration</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('admin.navbar-brands.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            <label for="logo_upload" class="form-label">Upload Logo Image</label>
                            <input type="file" 
                            ...
                            <small class="text-muted">Upload logo image (PNG, JPG, GIF - Max 2MB)</small>
                            @error('logo_upload')
                            ...
                            <div class="mt-3" id="logo_preview_container" style="display: none;">
                                <img id="logo_preview" src="" alt="Logo Preview" 
                                     style="max-width: 300px; max-height: 150px; border: 1px solid #ddd; padding: 10px; border-radius: 5px;">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">If not uploading, enter relative path to existing logo file</small>
                            @error('logo_path')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="logo_alt" 
                                   name="logo_alt" 
                                   value="{{ old('logo_alt', 'eclat pro ivoir') }}"
                                   placeholder="eclat pro ivoir">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="brand_name" 
                                   name="brand_name" 
                                   value="{{ old('brand_name', 'EPI - Eclat pro Ivoire') }}"
                                   placeholder="EPI - Eclat pro Ivoire">
