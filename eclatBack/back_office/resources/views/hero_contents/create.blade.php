...
@section('title', 'Create Hero Content')
        ...
        <div class="card radius-10">
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Create Hero Content</h5>
                    <a href="{{ route('admin.hero_contents.index') }}" class="btn btn-secondary btn-sm">Back to Hero Contents</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.hero_contents.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="primary_button_text" name="primary_button_text" value="{{ old('primary_button_text') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="primary_button_link" name="primary_button_link" value="{{ old('primary_button_link') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="secondary_button_text" name="secondary_button_text" value="{{ old('secondary_button_text') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="secondary_button_link" name="secondary_button_link" value="{{ old('secondary_button_link') }}">
                    ...
                    <div class="mb-3">
                        ...
                        @error('background_image')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Upload a background image (JPG, PNG, GIF) or enter a URL below</div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="background_image_url" class="form-label">Background Image URL</label>
                        <input type="text" class="form-control" id="background_image_url" name="background_image_url" value="{{ old('background_image_url') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" class="form-control form-control-color" id="background_color" name="background_color" value="{{ old('background_color', '#009900') }}">
