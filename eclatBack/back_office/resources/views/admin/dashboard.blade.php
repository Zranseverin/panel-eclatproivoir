            ...
            <div class="card radius-10">
              <div class="card-body">
                  <div class="d-flex align-items-center">
                      <div>
                          <p class="mb-0 text-secondary">Nombres rendez mensuel</p>
                          <h4 class="my-1">{{ $weeklyAppointments }}</h4>
                          <p class="mb-0 font-13 {{ $weeklyChangePercentage >= 0 ? 'text-success' : 'text-danger' }}">
                    <i class="bi bi-caret-{{ $weeklyChangePercentage >= 0 ? 'up' : 'down' }}-fill"></i> 
                    {{ number_format(abs($weeklyChangePercentage), 1) }}% 
           ...
           <div class="col">
              <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Rendez valider</p>
                            <h4 class="my-1">{{ $validatedAppointments }}</h4>
                           <p class="mb-0 font-13 {{ $validatedChangePercentage >= 0 ? 'text-success' : 'text-danger' }}">
                        <i class="bi bi-caret-{{ $validatedChangePercentage >= 0 ? 'up' : 'down' }}-fill"></i> 
                        {{ number_format(abs($validatedChangePercentage), 1) }}% par rapport à la semaine dernière
                    </p>
                        </div>
           ...
           <div class="col">
            <div class="card radius-10">
              <div class="card-body">
                  <div class="d-flex align-items-center">
                      <div>
                          <p class="mb-0 text-secondary">Total Presence mensuel</p>
                          <h4 class="my-1">5.8K</h4>
                          <p class="mb-0 font-13 text-danger"><i class="bi bi-caret-down-fill"></i> 2.7 par rapport à la semaine dernière</p>
                      </div>
              ...
              <div class="card-body">
                  <div class="d-flex align-items-center">
                      <div>
                          ...
                          <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill"></i> 12.2% par rapport à la semaine dernière</p>
                      </div>
            ...
            <div class="card radius-10 w-100">
              <div class="card-body">
                 <div class="row row-cols-1 row-cols-lg-2 g-3 align-items-center">
                    <div class="col">
                      <h5 class="mb-0">Total employé</h5>
                    </div>
                    <div class="col">
