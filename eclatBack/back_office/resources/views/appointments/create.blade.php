            ...
            <div class="card-body">
                <form action="{{ route('admin.appointments.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="service_type" name="service_type" value="{{ old('service_type') }}" required>
                                @error('service_type')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="desired_date" name="desired_date" value="{{ old('desired_date') }}" required>
                        @error('desired_date')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
