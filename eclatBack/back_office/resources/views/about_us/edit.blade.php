        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="bi bi-pencil me-2"></i>Edit About Us Content</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.about-us.update', $aboutUs->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              id="description" name="description" rows="5" required>{{ old('description', $aboutUs->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($aboutUs->image_path)
                                        <div class="mb-2">
                                            <img src="{{ asset($aboutUs->image_path) }}" alt="Current Image" class="img-thumbnail" style="max-height: 200px;">
                                        </div>
                                    @endif
                                    <input type="file" class="form-control @error('image_path') is-invalid @enderror" 
                                           id="image_path" name="image_path" accept="image/*">
                                    <small class="text-muted">Leave empty to keep current image. Recommended size: 600x700px</small>
                                    @error('image_path')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature1_icon') is-invalid @enderror" 
                                           id="feature1_icon" name="feature1_icon" value="{{ old('feature1_icon', $aboutUs->feature1_icon) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature1_title') is-invalid @enderror" 
                                           id="feature1_title" name="feature1_title" value="{{ old('feature1_title', $aboutUs->feature1_title) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature2_icon') is-invalid @enderror" 
                                           id="feature2_icon" name="feature2_icon" value="{{ old('feature2_icon', $aboutUs->feature2_icon) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature2_title') is-invalid @enderror" 
                                           id="feature2_title" name="feature2_title" value="{{ old('feature2_title', $aboutUs->feature2_title) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature3_icon') is-invalid @enderror" 
                                           id="feature3_icon" name="feature3_icon" value="{{ old('feature3_icon', $aboutUs->feature3_icon) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature3_title') is-invalid @enderror" 
                                           id="feature3_title" name="feature3_title" value="{{ old('feature3_title', $aboutUs->feature3_title) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature4_icon') is-invalid @enderror" 
                                           id="feature4_icon" name="feature4_icon" value="{{ old('feature4_icon', $aboutUs->feature4_icon) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature4_title') is-invalid @enderror" 
                                           id="feature4_title" name="feature4_title" value="{{ old('feature4_title', $aboutUs->feature4_title) }}">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $aboutUs->is_active) ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_active">Active</label>
                        </div>

                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i> Update About Us Content
                            </button>
