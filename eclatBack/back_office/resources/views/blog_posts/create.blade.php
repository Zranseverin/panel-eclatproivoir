        ...
        <div class="card radius-10">
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Créer un Article de Blog</h5>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @error('image')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Téléchargez une image pour illustrer l'article</div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                @error('author_image')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Téléchargez une image pour l'auteur</div>
                            </div>
                            
                            <div class="mb-3">
                                <label for="author_image_url" class="form-label">URL de l'Image de l'Auteur</label>
                                <input type="text" class="form-control" id="author_image_url" name="author_image_url" value="{{ old('author_image_url') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="views" name="views" value="{{ old('views', 0) }}" min="0">
                                @error('views')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="comments" name="comments" value="{{ old('comments', 0) }}" min="0">
                                @error('comments')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
